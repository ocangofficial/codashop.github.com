        ...
        var s = c,
                ...
                if (null != t && "object" == r(t) && "object" == r(t.images) && 0 != t.images.length) {
                    ...
                    $.each(t.images, function(t, o) {
                        if ("string" == typeof o.starttime) {
                            var r = new Date(o.starttime).getTime();
                            if (isNaN(r)) return console.log("Invalid starttime."), !0;
                            if (n < r) return !0
                        }
                        if ("string" == typeof o.endtime) {
                            var i = new Date(o.endtime).getTime();
                            if (isNaN(i)) return console.log("Invalid endtime."), !0;
                            if (n > i) return !0
                        }
                        o.srcUrl = "string" == typeof o.srcUrl ? o.srcUrl : "", o.altText = "string" == typeof o.altText ? o.altText : "No Alternate Text", "string" == typeof o.href ? "" == o.href && (o.href = "javascript:void(0)") : o.href = "javascript:void(0)", e += '<a target="_blank" class="promo-banner-cell" href="' + o.href + '"><img class="promo-banner-image" alt="' + o.altText + '" data-flickity-lazyload="' + o.srcUrl + '" /></a>', a++
            ...
            y = function(t) {
                if (null != t && "object" == a(t) && "object" == a(t.content) && 0 != t.content.length) {
                    ...
                    $.each(t.content, function(t, r) {
                        ...
                        r.imageUrl = "string" == typeof r.imageUrl ? r.imageUrl : "", r.altText = "string" == typeof r.altText ? r.altText : "No Alternate Text", "string" == typeof r.href ? "" == r.href && (r.href = "javascript:void(0)") : r.href = "javascript:void(0)", "" == r.title ? (e += '<div class="news__card-cell">', "" != r.newsPromotionsUrl ? (e += '<a target="_blank" href="' + r.newsPromotionsUrl + '" class="news_card_link">', e += '<img class="news__card-banner news__card-banner--full lozad" alt="' + r.altText + '" data-src="' + r.imageUrl + '" />', e += "</a>") : e += '<img class="news__card-banner news__card-banner--full lozad" alt="' + r.altText + '" data-src="' + r.imageUrl + '" />', e += "</div>") : (e += '<div class="news__card-cell">', "" != r.newsPromotionsUrl ? (e += '<a target="_blank" class="news_card_link" href="' + r.newsPromotionsUrl + '" class="">', e += '<div class="news__card-banner-frame"><img class="news__card-banner lozad" alt="' + r.altText + '" data-src="' + r.imageUrl + '" /></div>', e += '<div class="new__card-content-block"><div class="news__card-content-title">' + r.title + "</div>", e += '<div class="news__card-content-desc"> ' + r.subTitle + "</div></div>", e += "</a>") : (e += '<div class="news__card-banner-frame"><img class="news__card-banner lozad" alt="' + r.altText + '" data-src="' + r.imageUrl + '" /></div>', e += '<div class="new__card-content-block"><div class="news__card-content-title">' + r.title + "</div>", e += '<div class="news__card-content-desc"> ' + r.subTitle + "</div></div>"), e += "</div>")
            ...
            v = function(t) {
                ...
                try {
                    for (var a, i = t.products[Symbol.iterator](); !(o = (a = i.next()).done); o = !0) {
                        var c = a.value;
                        if (c.productUrl.startsWith("/")) {
                            var l = c.productUrl.substring(1);
                            e += '<a href="' + m.value + l + '" class="category__product-container js-link-click">'
                        } else e += '<a href="' + c.productUrl + '" class="category__product-container js-link-click" target="_blank">';
                        e += '<img data-src="' + c.thumbnailUrl + '" alt="" class="category__product-image lozad">', e += '<div class="category__product-title">' + c.productName + "</div>", e += "</a>"
                    }
                } catch (t) {
                    r = !0, n = t
                } finally {
            ...
            _ = function(t) {
                for (var e in t)
                    if (e.indexOf("-")) {
                        var o = e.split("-")[0];
                        "howToBannerSection" == o ? f(t[e]) : "promoBannerSection" == o ? u(t[e]) : "categorySection" == o ? v(t[e]) : "aboutSection" == o ? b(t[e]) : "newsBannerSection" == o && y(t[e])
                    } else "howToBannerSection" == e ? f(t.howToBannerSection) : "promoBannerSection" == e ? u(t.promoBannerSection) : "categorySection" == e ? v(t.categorySection) : "aboutSection" == e ? b(t.aboutSection) : "newsBannerSection" == e && y(t.newsBannerSection);
                return !0
            };
